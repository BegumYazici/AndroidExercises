...
public abstract class Hilt_ScoreFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_ScoreFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((ScoreFragment_GeneratedInjector) generatedComponent()).injectScoreFragment(UnsafeCasts.<ScoreFragment>unsafeCast(this));
  }
