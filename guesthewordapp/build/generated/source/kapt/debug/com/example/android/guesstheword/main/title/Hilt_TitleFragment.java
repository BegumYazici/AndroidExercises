...
public abstract class Hilt_TitleFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_TitleFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((TitleFragment_GeneratedInjector) generatedComponent()).injectTitleFragment(UnsafeCasts.<TitleFragment>unsafeCast(this));
  }
