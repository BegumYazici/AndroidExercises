...
public class GameFragmentBindingImpl extends GameFragmentBinding implements com.example.android.guesstheword.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.gameViewModel == variableId) {
            setGameViewModel((com.example.android.guesstheword.main.game.GameViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setGameViewModel(@Nullable com.example.android.guesstheword.main.game.GameViewModel GameViewModel) {
    ...
    protected void executeBindings() {
        ...
        com.example.android.guesstheword.main.game.GameViewModel gameViewModel = mGameViewModel;
        ...
        if ((dirtyFlags & 0x31L) != 0) {
            ...
            this.timerText.setText(gameViewModelCurrentTimeStringGetValue);
        }
        if ((dirtyFlags & 0x38L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.wordHint, gameViewModelWordHintGetValue);
        }
        if ((dirtyFlags & 0x32L) != 0) {
            // api target 1
